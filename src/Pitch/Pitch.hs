...
generatePitchVars pitchNames = concat <$> forM pitchNames \name -> do
...
-- Enharmonic equivalence for Pitch
...
----import           Language.Haskell.TH.Syntax
----import Pitch.Accidental
----    ( Accidental(DoubleSharp, Sharp, Flat, QuarterSharp, QuarterFlat,
----                 Natural, ThreeQuartersFlat, ThreeQuartersSharp, DoubleFlat),
